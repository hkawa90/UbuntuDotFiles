...
alias gdrive_m='google-drive-ocamlfuse $HOME/GoogleDrive'
alias gdrive_u='fusermount -u $HOME/GoogleDrive'
...
alias emac_compile="/bin/snap run emacs -batch -f batch-byte-compile "
alias ema="/bin/snap run emacs -mm"
alias emac="/bin/snap run emacsclient -c"
alias emanc="/bin/snap run emacsclient -nc"
alias emac_start="/bin/snap run emacs --daemon"
alias emac_stop="/bin/snap run emacsclient -e '(kill-emacs)'"
